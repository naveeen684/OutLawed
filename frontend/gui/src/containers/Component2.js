...
function Component2() {
    return (
        <Spring from={{opacity:0}} to={{opacity:1}} config={{delay:5000,duration:1000}}>
        {props=>(
            <div style={{props}}>
                <MDBContainer  style={{height:'10%' ,width:'50%'}}>
                <MDBRow >
                    <MDBCol >
                    <MDBJumbotron style={{ borderRadius:"20px", padding: 0 ,backgroundColor: "#016B86"}}>
                        <MDBCol className= "rounded-100 py-1" style={{color:"white"}}>
                            <MDBCardTitle className="h1-responsive pt-3 m-5 font-bold"><h1 style={{color:"white",fontSize:"42px",fontFamily:"Montserrat"}}>OUR MISSION</h1></MDBCardTitle>
                            <p style={{fontSize:"16px",fontFamily:"Montserrat"}} className="mx-5 responsive mb-5 text-center">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repellat fugiat, laboriosam, voluptatem,
